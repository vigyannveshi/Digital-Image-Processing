...
class PlottingFunctions:
    ...
    def plot(self,img_lst,titles,fig_no,gd,fig_title,save_title,fig_size=(13,8),fig_pad=2,fig_font='Times New Roman',fig_fontweight="bold",fig_fontsize=16,fig_dpi=500,grid=False,axis=False):
