...
plt.suptitle(f'Addition (Averaging) of noisy images (mean=0,variance={v}, gaussian noise) for noise reduction',font='Times New Roman',fontweight="bold",fontsize=16)
plt.tight_layout(pad=1.2)
fig1.set_size_inches(10, 8)
plt.savefig('input_output/expt5_a.jpg',dpi=300,)
