...
url.png('input_output\A_expt4b_qr_code.png',scale=1)

qrcode=plt.imread('input_output\A_expt4b_qr_code.png')
...
plt.imsave('input_output\A_expt4b_qrcode_shrinked.jpg',inplt.nearest_neighbourhood(qrcode,(int(ss*r),int(ss*c))),cmap='gray')

sqrcode=plt.imread('input_output\A_expt4b_qrcode_shrinked.jpg')
...
plt.savefig('input_output\A_expt4b_resizing_qrcode.jpg',dpi=300)
fig1.set_size_inches(5, 4)
plt.show()


# Saving zoomed QR code:
plt.imsave('input_output\A_expt4b_qrcode_zoomed.jpg',inplt.nearest_neighbourhood(qrcode,(sz*rs,sz*cs)),cmap='gray')