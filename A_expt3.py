...
fig1.savefig('input_output\A_expt3_dpi_1250.jpg',dpi=1250)

fig2=plt.figure(2,dpi=300)
plt.axis('off')
plt.imshow(img1,cmap='gray',interpolation='none')
fig2.savefig('input_output\A_expt3_dpi_300.jpg',dpi=300)

fig3=plt.figure(3,dpi=150)
plt.axis('off')
plt.imshow(img1,cmap='gray',interpolation='none')
fig2.savefig('input_output\A_expt3_dpi_150.jpg',dpi=150)

fig4=plt.figure(4,dpi=72)
plt.axis('off')
plt.imshow(img1,cmap='gray',interpolation='none')
fig2.savefig('input_output\A_expt3_dpi_72.jpg',dpi=72)

'''Getting the generated images with reduced spatial resolution '''

img1250=plt.imread('input_output\A_expt3_dpi_1250.jpg')
img300=plt.imread('input_output\A_expt3_dpi_300.jpg')
img150=plt.imread('input_output\A_expt3_dpi_150.jpg')
img72=plt.imread('input_output\A_expt3_dpi_72.jpg')
...
plt.savefig('input_output/A_expt3.jpg',dpi=1250)
plt.show()  